...
abstract class AbstractLongSorter {
  public void sort(long[] array, int size) {
  ...
  private void _sort(long[] array, int first, int last) {
    if (first >= last)
      return;
  ...
  private void swap(int idx1, int idx2, long[] array) {
    long tmp = array[idx1];
  ...
  protected abstract boolean isGreater(long value1, long value2);
}
