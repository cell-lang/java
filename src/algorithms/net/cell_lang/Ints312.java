...
class Ints312 {
  ...
  public static boolean contains13(int[] array, int size, int val1, int val3) {
    ...
    while (low <= high) {
      ...
      switch (rangeCheck31(mid, val3, val1, array)) {
  ...
  public static boolean contains3(int[] array, int size, int val3) {
    ...
    while (low <= high) {
      int mid = low + (high - low) / 2;
      switch (rangeCheck3(mid, val3, array)) {
        case -1: // mid < target range
          low = mid + 1;
          break;
  ...
  static int rangeCheck31(int idx, int val3, int val1, int[] array) {
    int offset = 3 * idx;
  ...
  static int rangeCheck3(int idx, int val3, int[] array) {
    int offset = 3 * idx;
    int val = array[offset + 2];
    if (val < val3)
      return -1;
