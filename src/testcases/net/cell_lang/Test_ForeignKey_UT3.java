      ...
      for (int r1=1 ; r1 < r ; r1++)
        for (int r2=1 ; r2 < r ; r2++)
          for (int r3=1 ; r3 < r ; r3++)
            if (!done[r1][r2][r3]) {
              new Test_ForeignKey_UT3().run(r1, r2, r3, 10000);
              done[r1][r2][r3] = true;
            }
  }
...
loop1:    for (int i1=0 ; i1 < r1 ; i1++)
      ...
      boolean ok2 = targetUpdater.checkForeignKeys_3(sourceUpdater);
...
//           }
        ...
        boolean ok3 = targetUpdater.checkForeignKeys_3(sourceUpdater);
        boolean ok4 = targetUpdater.checkForeignKeys_3(sourceUpdater);
