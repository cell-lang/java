...
class Test_ForeignKey_UB2 {
  static Random rand = new Random(0);

  public static void run() {
    for (int r1=1 ; r1 < 40 ; r1++)
      for (int r2=1 ; r2 < 40 ; r2++)
        new Test_ForeignKey_UB2().run(r1, r2, 10000);

    for (int r1=1 ; r1 < 40 ; r1++)
      new Test_ForeignKey_UB2().run(r1, 1000, 10000);
  }
  ...
  void run(int r1, int r2, int testCount) {
    ...
    for (int _t=0 ; _t < testCount ; _t++) {
      ...
      boolean debugIt = targetUpdater.checkForeignKeys_2(sourceUpdater) != ok;
      ...
      if (debugIt) {
        ...
        dumpDiff(r1, r2);
        targetUpdater.checkForeignKeys_2(sourceUpdater);
        System.exit(1);
      }
