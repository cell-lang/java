...
class ForeignKeyCheckerTsBm {
  ...
  public ForeignKeyCheckerTsBm(SlaveTernaryTableUpdater source, MasterBinaryTableUpdater target) {
  ...
  private void checkTargetClear() {
    ...
    BinaryTable.Iter it = source.table.table3.getIter();
    while (!it.done()) {
      int surr12 = it.get1();
      int arg1 = source.table.table12.arg1(surr12);
      int arg2 = source.table.table12.arg2(surr12);
