...
class ForeignKeyCheckerBmU1 implements UnaryTableUpdater.DeleteChecker {
  ...
  public ForeignKeyCheckerBmU1(MasterBinaryTableUpdater source, UnaryTableUpdater target) {
    ...
    if (source.hasInsertions()) {
      ...
      for (int i=0 ; i < count ; i++) {
        ...
        if (!target.contains(arg1))
          throw insertionForeignKeyViolation(arg1, MasterBinaryTableUpdater.arg2(entry));
      }
    }
