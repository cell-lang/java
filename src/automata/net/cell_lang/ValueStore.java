...
class ValueStore {
  ...
  Obj[] values      = new Obj[INIT_SIZE]; // null when there's no value
  int[] hashcodes   = new int[INIT_SIZE]; // junk when there's no value
  int[] refCounts   = new int[INIT_SIZE]; //    0 when there's no value
  int[] nextFreeIdx = new int[INIT_SIZE]; // junk when there's a value

  int[] hashtable   = new int[INIT_SIZE]; //   -1 when there's no value in that bucket
  int[] buckets     = new int[INIT_SIZE]; // junk when there's no value
